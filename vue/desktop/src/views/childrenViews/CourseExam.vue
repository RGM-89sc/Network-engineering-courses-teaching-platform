<template>
  <div>
    ...
    <el-row>
      <el-card v-for="examPaper in examPapers" :key="examPaper.examID" class="exam-paper">
        <el-row>
          <el-col :span="18">
            <span class="exam-name" @click="enterExam(examPaper)">{{examPaper.examName}}</span>
          </el-col>
        ...
        <el-row>
          <el-col>
            ...
            >考试有效期：{{$dayjs(examPaper.startTime).format('YYYY/MM/DD HH:mm:ss')}} - {{$dayjs(examPaper.endTime).format('YYYY/MM/DD HH:mm:ss')}}</span>
          </el-col>
        </el-row>
      </el-card>
    </el-row>
